...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `owncloud` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
INSERT INTO `oc_appconfig` VALUES ('core','installedat','1354061889.7193'),('core','lastupdatedat','1354061889.7256'),('files_versions','installed_version','1.0.2'),('files_versions','types','filesystem'),('files_versions','enabled','yes'),('media','installed_version','0.4.3'),('core','remote_ampache','media/remote.php'),('media','enabled','yes'),('files_texteditor','installed_version','0.3'),('files_texteditor','enabled','yes'),('files_imageviewer','installed_version','1.0'),('files_imageviewer','enabled','yes'),('files','installed_version','1.1.6'),('core','remote_files','files/appinfo/remote.php'),('core','remote_webdav','files/appinfo/remote.php'),('core','remote_filesync','files/appinfo/filesync.php'),('files','types','filesystem'),('files','enabled','yes'),('user_migrate','installed_version','0.1'),('user_migrate','enabled','yes'),('admin_migrate','installed_version','0.1'),('admin_migrate','enabled','yes'),('contacts','installed_version','0.2.4'),('core','remote_contacts','contacts/appinfo/remote.php'),('core','remote_carddav','contacts/appinfo/remote.php'),('contacts','enabled','yes'),('files_sharing','installed_version','0.3.3'),('core','public_files','files_sharing/public.php'),('core','public_webdav','files_sharing/public.php'),('files_sharing','types','filesystem'),('files_sharing','enabled','yes'),('files_odfviewer','installed_version','0.1'),('files_odfviewer','enabled','yes'),('gallery','installed_version','0.5.1'),('core','public_gallery','gallery/sharing.php'),('gallery','enabled','yes'),('calendar','installed_version','0.6.1'),('core','remote_calendar','calendar/appinfo/remote.php'),('core','remote_caldav','calendar/appinfo/remote.php'),('core','public_calendar','calendar/share.php'),('core','public_caldav','calendar/share.php'),('calendar','enabled','yes'),('files_pdfviewer','installed_version','0.1'),('files_pdfviewer','enabled','yes'),('core','remote_core.css','/core/minimizer.php'),('core','remote_core.js','/core/minimizer.php'),('core','backgroundjobs_task','OC_Cache_FileGlobal-gc'),('core','global_cache_gc_lastrun','1354061893'),('core','backgroundjobs_step','regular_tasks');
...
INSERT INTO `oc_fscache` VALUES (1,'/admin/files','dbb5f96946862a55abb65ee90e3cf566',-1,'files','admin',0,1354061889,1354061889,'httpd/unix-directory','httpd',0,0,1);
...
INSERT INTO `oc_users` VALUES ('admin','$2a$08$2r8piE/OznLcuymrytys3.8La5Z73YZngnIPR43ARDDdYhoe2UJQ.');
...
-- Dump completed on 2012-11-28  8:16:06
